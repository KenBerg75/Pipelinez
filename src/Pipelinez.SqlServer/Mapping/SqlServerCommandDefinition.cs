...
/// <summary>
/// Represents a parameterized SQL Server command that the transport can execute through Dapper.
/// </summary>
public sealed class SqlServerCommandDefinition
{
    /// <summary>
    /// Initializes a new SQL Server command definition.
    /// </summary>
    ...
    public SqlServerCommandDefinition(string commandText, object? parameters, int? commandTimeoutSeconds = null)
    {
    ...
    public SqlServerCommandDefinition Validate()
    {
